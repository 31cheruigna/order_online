                     ...
                     <div class="col-md-4">
                        ...
                        <div class="panel">
                           <div class="panel-heading">
                              <h4 class="panel-title"><a data-parent="#accordion" data-toggle="collapse" class="panel-toggle collapsed" href="#faq1" aria-expanded="false"><i class="ti-info-alt" aria-hidden="true"></i>Can 1 cartoon be a lot of what lacinia needs?</a></h4>
                           </div>
                           <div class="panel-collapse collapse" id="faq1" aria-expanded="false" role="article" style="height: 0px;">
                              <div class="panel-body"> The customer is very important, the customer will be followed by the customer. Even the makeup was from Ultricies. He is not responsible for the boat, but that is the bed of trucks. Now is the time for free peanuts, bananas, and chocolate. We do not carry it in our lives, but in the pillow itself. It is important to know how to make a salad. The children's layer of poison. Children should be told justly, sometimes not hatefully, but said otherwise. Fusce sit amet turpi eget nibh elementum sagittis. Now the result is clear, in the result it is not the result. </div>
                           </div>
                        </div>
                        <!-- end:panel -->
                        <div class="panel">
                           <div class="panel-heading">
                              <h4 class="panel-title"><a data-parent="#accordion" data-toggle="collapse" class="panel-toggle" href="#faq2" aria-expanded="true"><i class="ti-info-alt" aria-hidden="true"></i>Can 1 cartoon be a lot of what lacinia needs?</a></h4>
                           </div>
                     ...
                     <div class="container">
                        <div class="row">
                           ...
                           <div class="col-xs-12 col-sm-4 address color-gray">
                              ...
                              <h5>Phone: <a href="tel:+0700000111">0700000111</a></h5>
                           </div>
